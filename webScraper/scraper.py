...
#TODO get course detailes is set to hard limit of 100 because is unlikely for it to be over 100 but should make it dynamic
class serachSession:
    protocol = "https://"
    ...
    def getCourseDetails(self, subjectCourseCombo: str):
        ...
        if not r:
            print(f"failed to get course details for {subjectCourseCombo}")
        return r.json()["data"]
